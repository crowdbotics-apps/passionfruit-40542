"""
Django settings for passionfruit_40542 project.
...
ROOT_URLCONF = 'passionfruit_40542.urls'
...
WSGI_APPLICATION = 'passionfruit_40542.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "passionfruit_40542 API",
    "DESCRIPTION": "API documentation for passionfruit_40542 App",
    "VERSION": "v1",
}
